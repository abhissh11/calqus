...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 bg-white dark:bg-black px-5 md:px-7 py-2 shadow-sm border-b flex justify-between items-center">
      {/* Logo */}
      <h1 className="text-neutral-800 dark:text-neutral-100 text-2xl font-bold">
        Calqus
      </h1>
      ...
      <div className="hidden md:block">
        <button className="px-4 py-2 text-white rounded-lg bg-violet-600 hover:bg-violet-700 cursor-pointer">
          Book a Call
        </button>
      </div>
