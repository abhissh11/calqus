  ...
  return (
    <main className="max-w-7xl mx-auto mt-16 px-4 md:px-8">
      <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-6">
        ...
        {/* Center Content */}
        <section className="md:col-span-3 lg:col-span-4 flex flex-col gap-6 overflow-hidden">
          {/* AI Interview Promo */}
          <div className="bg-violet-500 min-h-[5rem] flex justify-between items-center gap-4 px-4 py-2 rounded-lg border border-gray-100 shadow-sm shadow-violet-200">
            <div className="flex flex-col gap-1 items-start w-4/5 py-2">
              ...
              <p className="text-gray-200 text-sm font-normal w-4/5">
                ...
                looking for and get Instant Report card and feedback
              </p>
            </div>
        ...
        {/* Right Sidebar (Advt placeholder) */}
